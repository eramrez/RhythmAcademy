// src/lib.rs
/*
 * Core library for RhythmAcademy
 */
...
#[derive(Debug)]
pub struct RhythmAcademyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RhythmAcademyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RhythmAcademy processing");
    
    let mut processor = RhythmAcademyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RhythmAcademyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RhythmAcademyProcessor::new(false);
